...
export const ProfileInfoForm = ({ profileData, updateResumeSection }) => {
  return (
      ...
      <div className="space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Input
            ...
            onChange={({ target }) =>
              updateResumeSection("fullName", target.value)
            }
          />
          ...
          <Input
            ...
            onChange={({ target }) =>
              updateResumeSection("designation", target.value)
            }
          />
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              ...
              onChange={({ target }) =>
                updateResumeSection("summary", target.value)
              }
            />
          </div>
        </div>
