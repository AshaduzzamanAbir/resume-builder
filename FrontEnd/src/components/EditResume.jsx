...
const EditResume = () => {
  ...
  // added
  const updateResumeSection = (section, key, value) => {
    setResumeData((prev) => ({
      ...prev,
      [section]: {
        ...prev[section],
      ...
      case "profile-info":
        return (
          <ProfileInfoForm
            ...
            updateResumeSection={(key, value) =>
              updateResumeSection("profileInfo", key, value)
            }
        ...
        return (
          <ContactInfoForm
            ...
            updateSection={(key, value) =>
              updateResumeSection("contactInfo", key, value)
            }
          />
        );
  ...
  // Update resume details API call
        ...
        <div className="relative">
          <div className="text-center mb-4">
            <div className={statusStyles.modalBadge}>
              <div className={iconStyles.pulseDot}></div>
              <span className="">Completetion: {completionPercentage}%</span>
            </div>
          </div>
          ...
          <div className={containerStyles.pdfPreview}>
            <div>
              <div>
                <RenderResume
                  key={`pfg-${resumeData?.template?.theme}`}
                  templateId={resumeData?.template?.theme || ""}
                  resumeData={resumeData}
                  containerWidth={null}
                />
