          ...
          <div className={landingPageStyles.heroGrid}>
            ...
            <div className={landingPageStyles.heroLeft}>
              ...
              <p className={landingPageStyles.description}>
                Create job-Winning Resume Expertly designed template.
                ATS-frendly Recruiter Apprved , and tolarete your carer goals.
              </p>
          ...
          <div className={landingPageStyles.featuresContainer}>
            <div className={landingPageStyles.featuresHeader}>
              ...
              <p className={landingPageStyles.featureDescription}>
                Everthing you need to create a Professioal reusme that stands
                out{" "}
              </p>
            </div>
            ...
            <div className={landingPageStyles.ctaCard}>
              ...
              <div className={landingPageStyles.ctaCardContent}>
                ...
                <p className={landingPageStyles.ctaDescription}>
                  join thousends of professionals who landed their dream jobs
                  with our platform
                </p>
      ...
      <footer className={landingPageStyles.footer}>
        <div className={landingPageStyles.footerContainer}>
          <p className={landingPageStyles.footerText}>
            Crefted With
            <span className={landingPageStyles.footerHeart}>❤</span> by{" "}
            <a
              href="www.ashaduzzamantaluckder.com"
              target="_blank"
              className={landingPageStyles.footerLink}
            >
              Ashaduzzaman Taluckder
            </a>
          </p>
        </div>
      </footer>
      {/* model for login and signup setup  */}
